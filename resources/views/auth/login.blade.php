...
<body class="bg-gray-100 flex justify-center items-center min-h-screen relative overflow-hidden">
    <div class="absolute inset-0 bg-cover bg-center blur-md opacity-90" style="background-image: url('/img/imagen.jpeg');"></div>
    <div class="relative bg-white rounded-lg shadow-xl overflow-hidden flex max-w-4xl w-full min-h-[600px]">
        <div class="flex-[6] bg-cover bg-center" style="background-image: url('/img/imagen.jpeg')"></div>
        <div class="flex-[4] flex justify-center items-center p-8">
            <div class="w-full max-w-md">
                <div class="flex flex-col items-center mb-6">
                    ...
                    <h2 class="text-3xl font-extrabold text-brown-800 text-center">Picantería Doña Marvin</h2>
                </div>
